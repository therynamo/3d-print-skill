...
| OpenSCAD | text→model, PNG preview, STL export | `brew install --cask openscad@snapshot` (the 2021.01 cask is Intel-only and fails on Apple Silicon — must use the native snapshot) |
